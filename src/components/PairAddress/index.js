...
import { AddressContainer, AddressTopContainer, HamContainer, SearchContainer, AddressTopNavContainer, AddressTopLogoHeading, AddressTopHamburgerContainer, AddressTopContainerMobileView, SearchInput, SearchButton, ConnectButton, PageHeading, SearchResultsContainer, LoaderContainer } from '../TokenAddress/styledComponents'
...
const searchUrl = "https://api.dexscreener.com/latest/dex/search/?q=Etherium"

class PairAddress extends Component {
    state = {searchResult: [], status: apiStatus.initial, searchInput: "", ham: false}

    componentDidMount() {
        this.getTokenAddress(searchUrl)
    }
    ...
    render() {
        ...
        return (
            <AddressContainer>
                ...
                <PageHeading>Pair Search Results</PageHeading>
